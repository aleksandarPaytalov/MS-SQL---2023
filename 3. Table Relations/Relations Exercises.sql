...
CREATE TABLE Agenda
(
StudentID INT FOREIGN KEY REFERENCES Students_TASK_06(StudentID),
...
SudentID INT FOREIGN KEY REFERENCES Students_TASK_06(StudentID)
)
